...
background: linear-gradient(135deg,#ffe4ec,#fff,#ffe4ec);
display:flex;
...
.section{margin-top:30px;animation:fadeUp .8s;}
...
.contact a:hover{transform:scale(1.08);}
...
font-size:22px;
margin-top:15px;
animation:sakuraFloat 3s infinite;
}
